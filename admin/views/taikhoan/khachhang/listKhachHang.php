                                ...
                                <tbody>
                                    ...
                                    foreach ($listKhachHang as $key => $khachHang): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <img src="<?= BASE_URL . $khachHang['anh_dai_dien'] ?>" style="width: 100px;" style="width: 100px" alt="" onerror="this.onerror=null; this.src='https://cutepetshop.vn/wp-content/uploads/2023/05/11-bu-'">
                                            </td>
