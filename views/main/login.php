                ...
                <div class="auth-container">
                    <div class="auth-row">
                        <div class="auth__login auth__block">
                            <h3 class="auth__title">Bạn đã có tài khoản STYLMART</h3>
                        ...
                        <div class="auth__register auth__block">
                            <h3 class="auth__title">Khách hàng mới của STYLMART</h3>
                            <div class="auth__login__content">
                                <p class="auth__description">
                                    Nếu bạn chưa có tài khoản trên STYMART.com, hãy sử dụng tùy chọn này để truy cập
                                    biểu mẫu đăng ký.
                                </p>
                                <p class="auth__description">
                                    Bằng cách cung cấp cho STYLMART moda thông tin chi tiết của bạn, quá trình mua hàng
