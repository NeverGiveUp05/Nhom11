                                ...
                                <div class="sidebar-body">
                                    <ul class="shop-categories">
                                        <?php foreach ($listDanhMuc as $danhMuc)
                                            if ($danhMuc['id'] == $danhMucId) { ?>
                                            <li><a href="<?php echo BASE_URL . '?act=category&id=' . $danhMuc['id'] ?>" class="active"><?php echo $danhMuc['ten_danh_muc'] ?></a></li>
                                        <?php } else { ?>
...
============================================ -->
    ...
    <script>
        ...
        $("#wrap-sort").on('change', 'select', function() {
            ...
            fetch(`<?= BASE_URL . '?act=sort&id=' . $_GET['id'] . '&by=' ?>${sortValue}`)
